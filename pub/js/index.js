...
cljs.core.with_meta = function with_meta(b, c) {
  return function() {
    ...
    void 0 === cljs.core.t3262 && (cljs.core.t3262 = {}, cljs.core.t3262 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta3263 = g;
    ...
    }, cljs.core.t3262.cljs$lang$type = !0, cljs.core.t3262.cljs$lang$ctorStr = "cljs.core/t3262", cljs.core.t3262.cljs$lang$ctorPrWriter = function(b, c, f) {
      return cljs.core._write.call(null, c, "cljs.core/t3262")
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t3262.prototype.apply = function(b, c) {
      b = this;
      return b.call.apply(b, [b].concat(c.slice()))
    }, cljs.core.t3262.prototype.cljs$core$Fn$ = !0, cljs.core.t3262.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
      return this.meta3263
    }, cljs.core.t3262.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
      return new cljs.core.t3262(this.meta, this.o, this.with_meta, c)
    }, cljs.core.__GT_t3262 = function(b, c, f, g) {
      return new cljs.core.t3262(b, c, f, g)
    });
    return new cljs.core.t3262(c, b, with_meta, null)
...
var saetos = {cljs:{}};
saetos.cljs.app = {};
saetos.cljs.app.mainVideo = {};
saetos.cljs.app.mainVideo.FPS = 30;
saetos.cljs.app.mainVideo.frameInterval = 0.03;
saetos.cljs.app.mainVideo.init = function() {
    ...
    this.fire = function(b) {
      return function() {
        if(0.03 < a.currentTime - a.timeStamp) {
          var c = a.currentTime, d = elements.mainVideo.timeline[Math.floor(30 * c)];
          a.timeStamp = c;
          cljs.core.truth_(d) ? d.call(null) : (c = elements.mainVideo.state, cljs.core._EQ_.call(null, c, 0) || elements.mainVideo.takeDowns[c].call(null))
        }
...
saetos.cljs.util = {};
saetos.cljs.util.nodelist__GT_coll = function(a) {
  return function c(d) {
    return new cljs.core.LazySeq(null, !1, function() {
      for(;;) {
...
saetos.cljs.app.init = function() {
  saetos.cljs.app.mainVideo.init.call(null);
  saetos.cljs.app.narratorVideo.init.call(null);
  dev.init.call(null);
  elements.mainVideo.state = 1;
  return null
};
saetos.cljs.css = {};
saetos.cljs.css.setOpacity = function(a, b) {
...
dev.init = function() {
  window.onbeforeunload = function() {
    return cljs.core.truth_(dev.autoReturnCheckbox.checked) ? cljs.core.truth_(function() {
      var a = isNaN(dev.timeReturnField.value);
      return cljs.core.truth_(a) ? a : cljs.core._EQ_.call(null, "", dev.timeReturnField.value)
    }()) ? localStorage.setItem("returnFrame", "N") : localStorage.setItem("returnFrame", dev.timeReturnField.value) : null
  };
...
dev.videoEditBarDragHandler = function(a) {
  ...
  b.fire = function(c) {
    ...
    c = (d = cljs.core._EQ_.call(null, c.type, "mouseup")) ? d : cljs.core._EQ_.call(null, c.type, "mouseout");
    return c ? b.selected = !1 : null
  };
  return b
};
saetos.cljs.app.narratorVideo = {};
saetos.cljs.app.narratorVideo.FPS = 30;
saetos.cljs.app.narratorVideo.frameInterval = 0.03;
saetos.cljs.app.narratorVideo.init = function() {
  ...
  return elements.narratorVideo.doFrame = new function(a) {
    this.fire = function(b) {
      return function() {
        if(0.03 < a.currentTime - a.timeStamp) {
          var c = a.currentTime, d = elements.narratorVideo.timeline[Math.floor(30 * c)];
          a.timeStamp = c;
...
saetos.cljs.idb = {};
goog.inherits(saetos.cljs.idb.Idb = function(a, b) {
  var c = this;
  ...
  c.put = function(a, b) {
    return c.db.createTransaction([c.store], goog.db.Transaction.TransactionMode.READ_WRITE).objectStore(c.store).put(a, b)
  };
  c.get = function(a, b) {
...
saetos.cljs.threads = {};
saetos.cljs.threads.Thread = function() {
  var a = this;
  a.thread = new Worker(URL.createObjectURL(new Blob([[cljs.core.str("onmessage \x3d "), cljs.core.str(function(a) {
...
saetos.cljs.time = {};
saetos.cljs.time.setTimeline = function(a, b) {
  cljs.core.not.call(null, b.timeLine) && (b.timeLine = cljs.core.PersistentArrayMap.EMPTY);
  return a.getAttribute("keyframes").match(RegExp("\\w+\\s+\\w+\\s+\\w+\\s+\\w+\\s+\\w+", "g")).forEach(function(c, d, e) {
    var f = c.split(RegExp("\\s+", "g"));
    c = parseInt(f[0]);
    d = f[1];
    e = parseInt(f[2]);
    for(var g = parseInt(f[3]), f = c + parseInt(f[4]), h = cljs.core.range.call(null, c, f), f = Math.round(100 * (1 / (f - c - 1))) / 100, k = cljs.core.atom.call(null, 0), h = cljs.core.seq.call(null, h), l = null, m = 0, n = 0;;) {
      if(n < m) {
        var p = cljs.core._nth.call(null, l, n), q = c + cljs.core.deref.call(null, k), s = b.timeLine.call(null, q), r = g > e ? e + cljs.core.deref.call(null, k) * f : e - cljs.core.deref.call(null, k) * f;
        cljs.core._EQ_.call(null, "opacity", d) && (cljs.core.truth_(s) ? b.timeLine = cljs.core.assoc.call(null, b.timeLine, q, cljs.core.cons.call(null, function(b, c, d, e, f, g, h, k) {
          return function() {
            return saetos.cljs.css.setOpacity.call(null, a, h)
          }
        }(h, l, m, n, q, s, r, p), b.timeLine.call(null, q))) : b.timeLine = cljs.core.assoc.call(null, b.timeLine, q, [function(b, c, d, e, f, g, h, k) {
          return function() {
            return saetos.cljs.css.setOpacity.call(null, a, h)
          }
        }(h, l, m, n, q, s, r, p)]));
        cljs.core.swap_BANG_.call(null, k, cljs.core.inc);
        n += 1
      }else {
        if(s = cljs.core.seq.call(null, h)) {
          q = s;
          if(cljs.core.chunked_seq_QMARK_.call(null, q)) {
            h = cljs.core.chunk_first.call(null, q), n = cljs.core.chunk_rest.call(null, q), l = h, m = cljs.core.count.call(null, h), h = n
          }else {
            var p = cljs.core.first.call(null, q), r = c + cljs.core.deref.call(null, k), t = b.timeLine.call(null, r), u = g > e ? e + cljs.core.deref.call(null, k) * f : e - cljs.core.deref.call(null, k) * f;
            cljs.core._EQ_.call(null, "opacity", d) && (cljs.core.truth_(t) ? b.timeLine = cljs.core.assoc.call(null, b.timeLine, r, cljs.core.cons.call(null, function(b, c, d, e, f, g, h, k, l, m) {
              return function() {
                return saetos.cljs.css.setOpacity.call(null, a, h)
              }
            }(h, l, m, n, r, t, u, p, q, s), b.timeLine.call(null, r))) : b.timeLine = cljs.core.assoc.call(null, b.timeLine, r, [function(b, c, d, e, f, g, h, k, l, m) {
              return function() {
                return saetos.cljs.css.setOpacity.call(null, a, h)
              }
            }(h, l, m, n, r, t, u, p, q, s)]));
